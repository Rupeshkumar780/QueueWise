...
export default function BusinessDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-linear-to-br from-gray-800 via-gray-600 to-gray-800 text-white px-4 py-8 sm:px-6 lg:px-8">
            ...
            {intelligence && (
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="bg-gray-900 px-5 py-3 flex items-center gap-2">
                  ...
                  <span className="ml-auto text-xs text-gray-500">Updates live</span>
                </div>
